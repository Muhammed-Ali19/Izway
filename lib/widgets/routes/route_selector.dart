            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () {
                    // Note: Le déblocage audio Web doit se faire ici ou dans map_screen via le callback
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // Sur PWA iOS / Safari, IL FAUT que l'interaction déclenche la préparation audio IMMÉDIATEMENT
                  // sinon l'audio context reste suspendu.
                  VoiceService().prepareWebAudio(); 
                  onStartNavigation();
                },
